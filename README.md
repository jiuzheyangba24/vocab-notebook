...
### 🌸 登录页面
精美的樱花主题登录界面，配有飘落的樱花动画效果。

![登录页面](docs/screenshots/login.png)

### 🏠 首页仪表盘
一目了然的学习进度总览，包含打卡日历和快捷操作。
...
![词库中心](docs/screenshots/library.png)

### 📊 学习统计
可视化图表展示学习进度和掌握情况。

![学习统计](docs/screenshots/statistics.png)

### 🤖 AI 智能助手
可拖拽的浮动 AI 助手，随时解答学习问题。

![AI助手](docs/screenshots/ai_assistant.png)
